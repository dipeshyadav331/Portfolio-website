        ...
        <div className="about-container">
          ...
          >
            ...
            <p className="about-me-text">
              ...
              <span className="para-c">new technologies</span> and fields. I am
              a focused person who loves to{" "}
            ...
            <p className="about-me-text">
              ...
              and I will graduate in <span className="para-c">2025</span>. I am
              a highly motivated and technically proficient student with a{" "}
              <span className="para-c">passion </span>
              for <span className="para-c">problem-solving </span>
              and <span className="para-c">software development</span>, skilled
              in <span className="para-c">Java, C++, JavaScript</span> and a
              range of <span className="para-c">web technologies</span>,
              including <span className="para-c">React, Redux</span>, and{" "}
              <span className="para-c">Node.js</span>, with a strong track
              record in <span className="para-c">competitive programming</span>{" "}
              and a commitment to <span className="para-c">leadership</span> and
              ...
              <ul>
                <li>
                  <h3>
                    <a
                      ...
                      target="blank"
                    >
                      <span className="cyan">Specialist</span>
                    </a>{" "}
                    at CodeForces
                  </h3>
                </li>
                <li>
                  <h3>
                    <a href="https://leetcode.com/yadavdipesh" target="blank">
                      <span className="cyan">Knight</span>
                    </a>{" "}
                    at Leetcode
                  </h3>
                </li>
                <li>
                  <h3>
                    Solved{" "}
                    <a
                      href="https://clist.by/coder/yadavdipesh/"
                      target="blank"
                    >
